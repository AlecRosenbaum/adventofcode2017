...
class Node(object):
    ...
    def get_children(self):
        return list(map(self.graph.get, self.children))
...
def solution_part_one(arg):
    ...
    for i in graph.nodes.values():
        if not root_node or i.cumulative_weight() > root_node.cumulative_weight():
            root_node = i
...
if __name__ == "__main__":
    puzzle_input = """bqyqwn (68) -> wscqe, cwxspl, syogw, xnxudsh
ddswb (34)
hnkvw (320)
